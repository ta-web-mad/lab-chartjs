...
function printMixedChart(selectedCoasters) {
  ...
  const firstHeightFiveCoaster = selectedCoasters.map((eachCoaster) => {
...
// , 'rgba(33, 192, 215, 1)', 'rgba(217, 158, 43, 1)', 'rgba(205, 58, 129, 1)
  // , 'rgba(33, 192, 215, 0.4)', 'rgba(217, 158, 43, 0.4)', 'rgba(205, 58, 129, 0.4)', 'rgba(156, 153, 204, 0.4)', 'rgba(225, 78, 202, 0.4)'